...
public class OrderBase implements Serializable {
    ...
    private List<Map<String, String>> budgetCode;
    ...
    public List<String> getAbnormalRules() {
        return abnormalRules;
    }

    public void setAbnormalRules(List<String> abnormalRules) {
        this.abnormalRules = abnormalRules;
    }
    ...
    public List<Map<String, String>> getBudgetCode() {
        return budgetCode;
    }

    public void setBudgetCode(List<Map<String, String>> budgetCode) {
    ...
    public String getPreDepartApplyCode() {
        return preDepartApplyCode;
    }

    public void setPreDepartApplyCode(String preDepartApplyCode) {
        this.preDepartApplyCode = preDepartApplyCode;
    }
    ...
    public Short getAbnormalStatus() {
        return abnormalStatus;
    }

    public void setAbnormalStatus(Short abnormalStatus) {
        this.abnormalStatus = abnormalStatus;
    }

    public Boolean getIsUserPay() {
        return isUserPay;
    }

    public void setIsUserPay(Boolean isUserPay) {
        this.isUserPay = isUserPay;
    }

    public String getIsNotUserPayReason() {
        return isNotUserPayReason;
    }

    public void setIsNotUserPayReason(String isNotUserPayReason) {
        this.isNotUserPayReason = isNotUserPayReason;
    }
    ...
    public String getPassengerPhoneVirtual() {
        return passengerPhoneVirtual;
    }

    public void setPassengerPhoneVirtual(String passengerPhoneVirtual) {
        this.passengerPhoneVirtual = passengerPhoneVirtual;
    }

    public String getUserPhoneVirtual() {
        return userPhoneVirtual;
    }

    public void setUserPhoneVirtual(String userPhoneVirtual) {
        this.userPhoneVirtual = userPhoneVirtual;
    }
}