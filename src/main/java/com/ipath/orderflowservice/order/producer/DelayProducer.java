...
@Component
@Slf4j
public class DelayProducer extends RocketMQTemplate {
    @Autowired
     ...
     * @param dataObject
     */
    public void sendDelayReport(JSONObject dataObject) {
        try {
    ...
    public void sendDelaySettle(JSONObject dataObject) {
        try {
            ...
            log.error("sendDelayReport ===>body:【{}】 ex:",JSONUtil.toJsonStr(dataObject),  e);
        }
    }
